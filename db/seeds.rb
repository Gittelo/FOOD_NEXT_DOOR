...
meal3  = Meal.create!(cook: user2, name: Faker::Food.unique.dish, description: Faker::Food.description, grams_per_dose: 250, ingredients: Faker::Food.ingredient, price: 4.0, address: "Rua de São Marçal 170, Lisboa",       photo: 'https://images.unsplash.com/photo-1503764654157-72d979d9af2f?ixlib=rb-0.3.5&ixid=eyJhcHBfaWQiOjEyMDd9&s=71cdddf5cc615224cf2c26614d20154d&auto=format&fit=crop&w=2553&q=80')
meal4  = Meal.create!(cook: user2, name: Faker::Food.unique.dish, description: Faker::Food.description, grams_per_dose: 200, ingredients: Faker::Food.ingredient, price: 2.9, address: "Rua de São Marçal 170, Lisboa",       photo: 'https://images.unsplash.com/photo-1484980972926-edee96e0960d?ixlib=rb-0.3.5&ixid=eyJhcHBfaWQiOjEyMDd9&s=f791b5847ff52ab502255c37c7e78498&auto=format&fit=crop&w=668&q=80')
meal5  = Meal.create!(cook: user3, name: Faker::Food.unique.dish, description: Faker::Food.description, grams_per_dose: 350, ingredients: Faker::Food.ingredient, price: 4.0, address: "Rua da Vitória 4, Lisboa",            photo: 'https://images.unsplash.com/photo-1513096010416-a2d75c794cf9?ixlib=rb-0.3.5&ixid=eyJhcHBfaWQiOjEyMDd9&s=e966da6f823c4750779d8f8a10c6a205&auto=format&fit=crop&w=1302&q=80')
meal6  = Meal.create!(cook: user3, name: Faker::Food.unique.dish, description: Faker::Food.description, grams_per_dose: 400, ingredients: Faker::Food.ingredient, price: 6.5, address: "Rua da Vitória 4, Lisboa",            photo: 'https://images.unsplash.com/photo-1519996409144-56c88c9aa612?ixlib=rb-0.3.5&ixid=eyJhcHBfaWQiOjEyMDd9&s=3637911ee7fd91ef9087dae6efc0114f&auto=format&fit=crop&w=668&q=80')
meal7  = Meal.create!(cook: user4, name: Faker::Food.unique.dish, description: Faker::Food.description, grams_per_dose: 250, ingredients: Faker::Food.ingredient, price: 4.9, address: "Avenida de Roma 39, Lisboa",          photo: 'https://images.unsplash.com/photo-1502114586089-b9480c602e18?ixlib=rb-0.3.5&ixid=eyJhcHBfaWQiOjEyMDd9&s=2a76f872362e6c5ec393cedd3b098cc2&auto=format&fit=crop&w=668&q=80')
meal8  = Meal.create!(cook: user4, name: Faker::Food.unique.dish, description: Faker::Food.description, grams_per_dose: 300, ingredients: Faker::Food.ingredient, price: 3.5, address: "Avenida de Roma 39, Lisboa",          photo: 'https://images.unsplash.com/photo-1490457843367-34b21b6ccd85?ixlib=rb-0.3.5&s=0c64f21bce4b02fb267b1900ccc2b523&auto=format&fit=crop&w=938&q=80')
meal9  = Meal.create!(cook: user5, name: Faker::Food.unique.dish, description: Faker::Food.description, grams_per_dose: 450, ingredients: Faker::Food.ingredient, price: 5.0, address: "Avenida São João de Deus 35, Lisboa", photo: 'https://images.unsplash.com/photo-1490457843367-34b21b6ccd85?ixlib=rb-0.3.5&s=0c64f21bce4b02fb267b1900ccc2b523&auto=format&fit=crop&w=938&q=80')
meal10 = Meal.create!(cook: user5, name: Faker::Food.unique.dish, description: Faker::Food.description, grams_per_dose: 450, ingredients: Faker::Food.ingredient, price: 5.0, address: "Avenida São João de Deus 35, Lisboa", photo: 'https://images.unsplash.com/photo-1490457843367-34b21b6ccd85?ixlib=rb-0.3.5&s=0c64f21bce4b02fb267b1900ccc2b523&auto=format&fit=crop&w=938&q=80')
...
WeekDay.create!(meal: Meal.find(1), pick_up_time_start: Time.zone.local(2018,06,14,21,00,00),
                                    pick_up_time_end:   Time.zone.local(2018,06,14,22,30,00),
                                    last_order_time:    Time.zone.local(2018,06,14,20,00,00),
                                    doses: 5,
                                    date: Date.new(2018,06,14))
WeekDay.create!(meal: Meal.find(2), pick_up_time_start: Time.zone.local(2018,06,14,20,30,00),
                                    pick_up_time_end:   Time.zone.local(2018,06,14,21,30,00),
                                    last_order_time:    Time.zone.local(2018,06,14,20,00,00),
                                    doses: 8,
                                    date: Date.new(2018,06,14))
WeekDay.create!(meal: Meal.find(3), pick_up_time_start: Time.zone.local(2018,06,14,20,00,00),
                                    pick_up_time_end:   Time.zone.local(2018,06,14,22,30,00),
                                    last_order_time:    Time.zone.local(2018,06,14,19,30,00),
                                    doses: 4,
                                    date: Date.new(2018,06,14))
WeekDay.create!(meal: Meal.find(4), pick_up_time_start: Time.zone.local(2018,06,14,20,30,00),
                                    pick_up_time_end:   Time.zone.local(2018,06,14,21,30,00),
                                    last_order_time:    Time.zone.local(2018,06,14,20,00,00),
                                    doses: 6,
                                    date: Date.new(2018,06,14))
WeekDay.create!(meal: Meal.find(5), pick_up_time_start: Time.zone.local(2018,06,14,22,00,00),
                                    pick_up_time_end:   Time.zone.local(2018,06,14,23,00,00),
                                    last_order_time:    Time.zone.local(2018,06,14,21,00,00),
                                    doses: 7,
                                    date: Date.new(2018,06,14))
WeekDay.create!(meal: Meal.find(6), pick_up_time_start: Time.zone.local(2018,06,14,20,30,00),
                                    pick_up_time_end:   Time.zone.local(2018,06,14,21,00,00),
                                    last_order_time:    Time.zone.local(2018,06,14,19,00,00),
                                    doses: 3,
                                    date: Date.new(2018,06,14))
